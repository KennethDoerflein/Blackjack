...
public class Blackjack_Cards {
    private static String version = "V2.1.4j";
    private static URL cardBack = Objects.requireNonNull(Blackjack_Cards.class.getResource("/assets/cards/allBlackBack.png"));
    private static int player1Total = 0 ;
    private static int dealerAces = 0;
    private static int dealerTotal = 0 ;
    private static int acesUnchanged = 0;
